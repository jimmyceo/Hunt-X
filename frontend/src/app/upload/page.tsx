      ...
      <main className="lg:ml-[260px] min-h-screen">
        <div className="max-w-2xl mx-auto px-6 py-6">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-2xl font-light text-[#061b31]">Upload Your Resume</h1>
            <Link
              href="/dashboard"
          ...
          {!result && (
            <div className="space-y-6">
              ...
              <div
                {...getRootProps()}
                className="border-2 border-dashed border-[#e5edf5] rounded-xl p-12 text-center hover:border-[#533afd] transition cursor-pointer bg-white"
              >
                <input {...getInputProps()} />
                {uploading ? (
