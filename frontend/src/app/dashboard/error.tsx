  ...
  return (
    <div className="min-h-screen bg-[#0B0B0F] flex items-center justify-center px-6">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-xl font-medium text-[#E8E8ED] mb-2">Dashboard Error</h1>
        <p className="text-sm text-[#8A8F98] mb-6">{error.message || 'Failed to load dashboard. Please try again.'}</p>
        <div className="flex items-center justify-center gap-3">
          ...
          <Link href="/" className="flex items-center gap-2 px-4 py-2 bg-white/[0.04] hover:bg-white/[0.06] border border-white/[0.10] text-[#E8E8ED] rounded-md text-sm font-medium transition-all duration-150">
