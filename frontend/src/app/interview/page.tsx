...
export default function InterviewPage() {
  ...
  const handleGenerate = async () => {
    ...
    setGenerating(true);
    try {
      const data = await apiClient.generateInterviewPrep(selectedEvalId);
      if (data?.id) {
        setResult(data);
        setActiveTab('star');
    ...
    <div className="min-h-screen bg-[#0B0B0F]">
      ...
      <main className="lg:ml-[260px] min-h-screen">
        <div className="max-w-[900px] mx-auto px-6 py-6">
            ...
            {loadingEvals ? (
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  disabled={!selectedEvalId || generating || checkingExisting}
          ...
          {!result && !generating && !checkingExisting && evaluations.length > 0 && (
