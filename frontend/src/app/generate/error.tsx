  ...
  return (
    <div className="min-h-screen bg-[#0B0B0F] flex items-center justify-center px-6">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-xl font-medium text-[#E8E8ED] mb-2">CV Generator Error</h1>
        <p className="text-sm text-[#8A8F98] mb-6">{error.message || 'Failed to generate CV. Please try again.'}</p>
